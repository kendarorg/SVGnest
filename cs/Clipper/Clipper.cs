...
namespace ClipperLib
{
  ...
  using cInt = Int32;
    ...
    public const cInt hiRange = 0x7FFF;
        ...
        internal   bool IsHorizontal(TEdge e)
        {
            return e.Delta.Y == 0;
        }
        //------------------------------------------------------------------------------
        ...
        internal   bool SlopesEqual(IntPoint pt1, IntPoint pt2,
    ...
    {
        public static void ScaleUpPath(Path path,double? scale=null)
        {
        ...
        public static void ScaleUpPaths(List<Path> paths, double? scale = null)
        {
      ...
      //------------------------------------------------------------------------------
        ...
        private   void SwapPolyIndexes(TEdge edge1, TEdge edge2)
        {
        ...
        private   int IntersectNodeSort(IntersectNode node1, IntersectNode node2)
        {
        ...
        internal   cInt Round(double value)
        {
            return value < 0 ? (cInt)(value - 0.5) : (cInt)(value + 0.5);
        }
        //------------------------------------------------------------------------------

        private   cInt TopX(TEdge edge, cInt currentY)
        {
        ...
        public   void ReversePaths(Paths polys)
        {
            foreach (var poly in polys) { poly.Reverse(); }
        }
        //------------------------------------------------------------------------------
        public static Clipper _clipper = new Clipper();
        ...
        public   int PointInPolygon(IntPoint pt, Path path)
        {
        ...
        private   OutRec ParseFirstLeft(OutRec FirstLeft)
        {
        ...
        public   Paths SimplifyPolygons(Paths polys,
            PolyFillType fillType = PolyFillType.pftEvenOdd)
        {
            Paths result = new Paths();
            Clipper c = new Clipper();
        ...
        private   Path TranslatePath(Path path, IntPoint delta)
        {
        ...
        public   Paths MinkowskiSum(Path pattern, Paths paths, bool pathIsClosed)
        {
        ...
        public   Paths MinkowskiDiff(Path poly1, Path poly2)
        {
        ...
        public   Paths PolyTreeToPaths(PolyTree polytree)
        {
        ...
        internal   void AddPolyNodeToPaths(PolyNode polynode, NodeType nt, Paths paths)
        {
            bool match = true;
            switch (nt)
            {
        ...
        public   Paths OpenPathsFromPolyTree(PolyTree polytree)
        {
            Paths result = new Paths();
        ...
        public   Paths ClosedPathsFromPolyTree(PolyTree polytree)
        {
            Paths result = new Paths();
            result.Capacity = polytree.Total;
    ...
    public class ClipperOffset
    {
        ...
        internal   DoublePoint GetUnitNormal(IntPoint pt1, IntPoint pt2)
        {
